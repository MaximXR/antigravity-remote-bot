...
*   [docs/DEVELOPER_INDEX.md](../../docs/DEVELOPER_INDEX.md) — Главная карта проекта и индекс документации. Читать в первую очередь для понимания взаимосвязей файлов, команд и базы данных.
